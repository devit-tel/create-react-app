...
function installDevDependency() {
  return new Promise(function(resolve, reject) {
    exec(
      'yarn add -D customize-cra react-app-rewired eslint prettier babel-eslint eslint-config-airbnb eslint-config-prettier eslint-plugin-flowtype eslint-plugin-import eslint-plugin-jsx-a11y eslint-plugin-prettier eslint-plugin-react @storybook/react @storybook/addon-actions @storybook/addon-links @storybook/addons @babel/plugin-proposal-decorators',
      (err, stdout, stderr) => {
        if (err) {
          // node couldn't execute the command
          return;
